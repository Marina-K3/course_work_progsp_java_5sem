    ...
    <section class="w-full h-[100vh]  bg-header  bg-cover bg-no-repeat bg-center bg-color1 bg-blend-multiply bg-opacity-60 " >
        ...
        <section class="w-full flex justify-center mt-[180px]" style="margin-top: 5px">
            <div class="w-[700px] md:w-[900px] container h-auto  ">
                <h2 class="w-full text-center uppercase text-white tracking-widest [word-spacing:8px] mb-4" style="font-size: 25px">${user.firstName}, здравствуйте!</h2>
                <h2 class="w-full text-center text-white text-5xl md:text-7xl font-secondary uppercase tracking-widest">МЕНЮ <span class="travol">Пользователя</span></h2>
            </div>
        </section>
                    ...
                    <form action="/editProfile" method="post" class="flex font-primary" style="margin-top: 45px">
                        ...
                        <div style="display: flex; flex-direction: column; flex-grow: 1; ">
                            <div style="display: flex; flex-direction: row;">
                                ...
                                <input type="text" name="lastName" placeholder="Фамилия" class="w-[25%] py-[15px] bg-white  ps-" style="padding-left: 10px;" required value="${user.lastName}">
                                <input type="text" name="firstName" placeholder="Имя" class="w-[25%] py-[15px] bg-white  ps-" style="padding-left: 10px; " required value="${user.firstName}">
                                <input type="text" name="passportNumber" placeholder="Номер паспорта" class="w-[25%] py-[15px] bg-white  ps-" style="padding-left: 10px; " required value="${user.passportNumber}">
                            </div>
                            <div style="display: flex; flex-direction: row;">
                                <input type = "email"   name="email" placeholder="Email" class="w-[25%] py-[15px] bg-white  ps-" style="padding-left: 10px; " required value="${user.email}">
                                <input type="tel" name="phone" placeholder="Телефон" required class="w-[25%] py-[15px] bg-white  ps-" style="padding-left: 10px; " required value="${user.phone}">
        ...
        <section class="w-full flex justify-center mt-[180px]" style="margin-top: 230px">
            <div class="w-full container 2xl:px-36 flex flex-wrap relative z-10 justify-center md:justify-between" style="justify-content: center">
